          ...
          <table class="table table-bordered dataTable" id="dataTable" width="100%" cellspacing="0">
            ...
            <tbody>
              <tr>
                ...
                <td><?php echo ($this->ion_auth->is_admin($user->id) ? 'Admnistrador' : 'Vendedor'); ?></td>
                <td class="text-center pr-4"><?php echo ($user ->active == 1 ? '<span class="badge badge-primary btn-sm">Sim</span>' : '<span class="badge badge-warning btn-sm">Não</span>') ?></td>
                <td class="text-right">
              ...
              <div class="modal fade" id="user-<?php echo $user->id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
                ...
                <div class="modal-dialog" role="document">
                  <div class="modal-content">
                    ...
                    <div class="modal-body">Para excluir o registro clica em <strong>sim</strong></div>
